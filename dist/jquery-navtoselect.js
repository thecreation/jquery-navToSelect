    ...
    var navToSelect = function() {
      ...
      _createClass(navToSelect, [{
        ...
        value: function init() {
          ...
          (0, _jquery2.default)(window).on("orientationchange",
        ...
        value: function buildOptions(items, level) {
          ...
          var options = '';
          _jquery2.default.each(items,

            function(index, item) {
              if (item.linkable === false && typeof item.items !== 'undefined' && level === 1 && _this2.options.useOptgroup) {
      ...
      return this.each(
        ...
        function() {
          if (!(0, _jquery2.default)(this).data(NAMESPACE)) {
            (0, _jquery2.default)(this).data(NAMESPACE, new navToSelect(this, options));
          }
        }
      );
    };
